      ...
      <div className="w-fit my-2 shadow rounded-md">
        <div className="rounded-md bg-white p-1">
          <nav className="flex flex-wrap gap-2  font-semibold">
            <a className="whitespace-nowrap inline-flex rounded-md py-1 px-3 items-center  text-sm  text-gray-400 bg-gray-100  transition-all duration-200 hover:cursor-pointer ease-in-out  hover:text-gray-700 hover:shadow">
              {" "}
              Products{" "}
            </a>
            <a className="whitespace-nowrap inline-flex rounded-md py-1 px-3 items-center  text-sm  text-gray-400 bg-gray-100 transition-all duration-200 ease-in-out hover:cursor-pointer  hover:text-gray-700 hover:shadow">
              {" "}
              Users{" "}
            </a>
            <a className="whitespace-nowrap inline-flex rounded-md items-center py-1 px-3 text-sm  text-black bg-white shadow font-semibold transition-all duration-200 hover:cursor-pointer ease-in-out">
              {" "}
              Tasks{" "}
            </a>
            <a className="whitespace-nowrap inline-flex rounded-md py-1 px-3 items-center  text-sm  text-gray-400 bg-gray-100 transition-all duration-200 ease-in-out hover:cursor-pointer  hover:text-gray-700 hover:shadow">
        ...
        <div className="relative overflow-hidden bg-white shadow rounded-md">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-sm text-left text-gray-500 :text-gray-400">
              ...
              <tbody>
                <tr className="border-b :border-gray-600 hover:bg-gray-100 :hover:bg-gray-700">
                  ...
                  <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap :text-white">
                    <div className="flex items-center">
                      ...
                      <span className="ml-1 text-gray-500 :text-gray-400">
                        5.0
                      </span>
                    </div>
                  </td>
                ...
                <tr className="border-b :border-gray-600 hover:bg-gray-100 :hover:bg-gray-700">
                  ...
                  <td className="px-4 py-2 font-medium text-gray-900 whitespace-nowrap :text-white">
                    <div className="flex items-center">
                      ...
                      <svg
                        aria-hidden="true"
                        className="w-5 h-5 text-gray-300 :text-gray-500"
                        fill="currentColor"
                        viewBox="0 0 20 20"
                        xmlns="http://www.w3.org/2000/svg"
                      >
          ...
          >
            ...
            <ul className="inline-flex items-stretch -space-x-px">
              ...
              <li>
                <a
                  href="#"
                  className="flex items-center justify-center px-3 py-2 text-sm leading-tight text-gray-500 bg-white border border-gray-300 hover:bg-gray-100 hover:text-gray-700 :bg-gray-800 :border-gray-700 :text-gray-400 :hover:bg-gray-700 :hover:text-white"
                >
                  1
                </a>
              </li>
