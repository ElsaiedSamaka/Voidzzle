const LightDecortor = () => {
  return (
    <svg
      className="w-full h-full absolute bg-light-bgSecondary"
    ...
    >
      <g mask='url("#SvgjsMask1076")' fill="none">
        ...
        <circle r={5} cx="1105.07" cy="-95.46" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1090.74" cy="38.31" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1098.9" cy="250.95" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1113.19" cy="381.68" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1148.69" cy="525.31" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1130.96" cy="689.58" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1298.24" cy="70.35" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1280.48" cy="195.72" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1254.04" cy="374.72" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1311.36" cy="536.39" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1248.37" cy="684.56" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1406.5" cy="-86.76" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1414.81" cy="93.38" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1437.15" cy="204.62" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1388.33" cy="412.08" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1396.9" cy="536.97" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1432.61" cy="687.76" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1545.52" cy="60.4" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1550.08" cy="223.16" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1562.7" cy="338.42" fill="rgba(185, 185, 185, 1)" />
        <circle r={5} cx="1583.05" cy="518.01" fill="rgba(185, 185, 185, 1)" />
