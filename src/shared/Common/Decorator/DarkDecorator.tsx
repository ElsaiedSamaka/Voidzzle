const DarkDecorator = () => {
  return (
    <svg
      className="w-full h-full absolute bg-dark-bgSecondary"
    ...
    >
      <g mask='url("#SvgjsMask1076")' fill="none">
        ...
        <path
          ...
          strokeWidth="1.5"
        />
        <circle r={5} cx="-64.96" cy="355.45" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="-71.57" cy="547.35" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="54.68" cy="396.27" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="93.1" cy="560.71" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="97.17" cy="644.95" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="234.05" cy="395.18" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="201.2" cy="508.56" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="244.51" cy="673.82" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="383.49" cy="386.65" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="406.95" cy="547.42" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="405.01" cy="708.55" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="490.91" cy="390.34" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="533.72" cy="699.52" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="695.08" cy="229.82" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="687.2" cy="362.48" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="689.67" cy="518.35" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="654.74" cy="686.13" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="846.41" cy="251.66" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="806.27" cy="398.91" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="861.53" cy="561.43" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="827.47" cy="669.47" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="959.77" cy="-43.12" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="982.12" cy="42.35" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="948.19" cy={201} fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="975.56" cy="367.11" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="968.67" cy="558.29" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="972.6" cy="643.36" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1105.07" cy="-95.46" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1090.74" cy="38.31" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1098.9" cy="250.95" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1113.19" cy="381.68" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1148.69" cy="525.31" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1130.96" cy="689.58" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1298.24" cy="70.35" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1280.48" cy="195.72" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1254.04" cy="374.72" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1311.36" cy="536.39" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1248.37" cy="684.56" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1406.5" cy="-86.76" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1414.81" cy="93.38" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1437.15" cy="204.62" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1388.33" cy="412.08" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1396.9" cy="536.97" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1432.61" cy="687.76" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1545.52" cy="60.4" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1550.08" cy="223.16" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1562.7" cy="338.42" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1583.05" cy="518.01" fill="rgba(41, 42, 42, 1)" />
        <circle r={5} cx="1580.46" cy="701.1" fill="rgba(41, 42, 42, 1)" />
        <path
